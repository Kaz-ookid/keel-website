...
(function () {
  ...
  var FRAG = [
    ...
    "  // The snow keeps out of the surface glass: gone while the top",
    "  // shimmer is strong, appearing only where it fades out. The floor",
    "  // band already buries the motes on its own.",
    "  float deep = 1.0 - max(smoothstep(0.22, 0.05, dive), smoothstep(0.78, 0.96, dive));",
